...
from neutron.db import base_db
from neutron.db import model_base
from neutron.db import models_v2
from neutron.extensions import ext_agent
from.neutron.extensions import ext_l2population
...
#        self.meter_rpc = metering_rpc_agent_api.MeteringAgentNotifyAPI()
    ...
    def create_fdb_entry(self, context, entry):
        m = entry['l2population_fdb_entry']
    ...
    def get_fdb_entries(self, context, filters=None, fields=None,
                        ...
                        page_reverse=False):
        marker_obj = self._get_marker_obj(context, 'fdb_entries', limit,
                                          marker)
